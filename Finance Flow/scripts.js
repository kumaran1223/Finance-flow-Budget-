...
function updateValues() {
    ...
    updateSpendingChart(income, expense); // Update the pie chart
    updateBudgetProgress(); // Update budget progress if set
}
...
function updateSpendingChart(income, expense) {
    ...
    if (window.spendingChart) {
        window.spendingChart.destroy(); // Destroy previous chart instance
    }
